#if !defined(XARM6_DEMO_APP1_CGRASP_WITH_PLAN_H)
#define XARM6_DEMO_APP1_CGRASP_WITH_PLAN_H
...
class CGraspWithPlan {
  public:
    explicit CGraspWithPlan(ros::NodeHandle& node_handle, CObjListManager& olm, CApproach& aprch);
...
#endif // XARM6_DEMO_APP1_CGRASP_WITH_PLAN_H
