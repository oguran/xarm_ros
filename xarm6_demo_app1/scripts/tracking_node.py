...
class testNode():
    def __init__(self):
        ...
        # Publisherの作成
        self.pub_target = rospy.Publisher('/camera/target', Point, queue_size=5)
    ...
    def callback(self, rgb_data, depth_data):
        ...
        x = x * depth_data.width / rgb_data.width
        y = y * depth_data.height / rgb_data.height
        ...
        z_int16 = d_img_array[int(x), int(y)]
        point = Point(x,y,float(z_int16))
